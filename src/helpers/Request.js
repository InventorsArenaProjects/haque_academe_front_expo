...
const http = new HttpHandler("https://inventorsarena.com/projects/haque_academy/api")
// ------------------API METHODS------------------------
...
export const notes = (subject_id) => {
    return http.getDataWithToken(NOTES + 't/1/s/' + subject_id)
