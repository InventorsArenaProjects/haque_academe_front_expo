    ...
    <TouchableOpacity
      ...
      onPress={() => {
        type === 'notes'
          ? navFunc1()
          : type === 'mcqTest'
          ? navFunc2(data.item.course_id)
          : navigation.navigate(SAQ_TEST_LIST, {subjectId: data.item.id});
      }}>
      <View
        style={{
          width: '40%',
        ...
        <Image
          style={styles.img}
          source={require('../../assets/images/mockbook.png')}></Image>
      </View>
